# Sftwre02_AICamera-withCameraViewer.md

<b>Author:</b> Audrey Luan </br>
<b>Date Written:</b> 2026 June 12, 04:34PM </br>
<b>Directory Path:</b> /aluan-CART-project_ucsc-ece129/src_AIcamera_py

### Notes

Part 2 of the Software subsystem appendices, includes all the code used to program the AI camera with real-time video seen in viewer window for the Raspberry Pi 5.

## ai_camera_basicTest.py
